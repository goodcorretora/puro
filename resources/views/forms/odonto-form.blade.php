    ...
    <section class="mt-12 container mx-auto lg:mt-24 lg:px-16">
        <div class="px-4 lg:px-0">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                ...
                <form action="{{ route('forms.odonto.submit') }}" method="post">
                    @csrf
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6">
                                    ...
                                    <select id="odonto" name="odonto" autocomplete="odonto" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-xs focus:outline-hidden focus:ring-primary-600 focus:border-primary-600 sm:text-sm">
