                            ...
                            <div class="shadow-sm overflow-hidden sm:rounded-md">
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    ...
                                    <div class="mt-4 space-y-4">
                                        ...
                                        <div class="flex items-start">
                                            <div class="flex h-5 items-center">
                                                <input id="ocupacional" name="ocupacional" type="checkbox" value="1" {{ old('ocupacional') ? 'checked' : '' }} class="h-4 w-4 rounded-sm border-gray-300 text-primary-600 focus:ring-primary-500">
                                            </div>
                                        ...
                                        <div class="flex items-start">
                                            <div class="flex h-5 items-center">
                                                <input id="seguranca" name="seguranca" type="checkbox" value="1" {{ old('seguranca') ? 'checked' : '' }} class="h-4 w-4 rounded-sm border-gray-300 text-primary-600 focus:ring-primary-500">
                                            </div>
                                            <div class="ml-3 text-sm">
                                        ...
                                        <div class="flex items-start">
                                            <div class="flex h-5 items-center">
                                                <input id="ergonomico" name="ergonomico" type="checkbox" value="1" {{ old('ergonomico') ? 'checked' : '' }} class="h-4 w-4 rounded-sm border-gray-300 text-primary-600 focus:ring-primary-500">
                                            </div>
                                            <div class="ml-3 text-sm">
                                        ...
                                        <div class="flex items-start">
                                            <div class="flex h-5 items-center">
                                                <input id="ambulatorio" name="ambulatorio" type="checkbox" value="1" {{ old('ambulatorio') ? 'checked' : '' }} class="h-4 w-4 rounded-sm border-gray-300 text-primary-600 focus:ring-primary-500">
                                            </div>
                                            <div class="ml-3 text-sm">
                                        ...
                                        <div class="flex items-start">
                                            <div class="flex h-5 items-center">
                                                <input id="pericia" name="pericia" type="checkbox" value="1" {{ old('pericia') ? 'checked' : '' }} class="h-4 w-4 rounded-sm border-gray-300 text-primary-600 focus:ring-primary-500">
                                            </div>
                                            <div class="ml-3 text-sm">
                                        ...
                                        <div class="flex items-start">
                                            <div class="flex h-5 items-center">
                                                <input id="promocao" name="promocao" type="checkbox" value="1" {{ old('promocao') ? 'checked' : '' }} class="h-4 w-4 rounded-sm border-gray-300 text-primary-600 focus:ring-primary-500">
                                            </div>
                                            <div class="ml-3 text-sm">
                                    ...
                                    <div class="flex items-center justify-end mt-4 px-4 py-3 bg-gray-50 text-right sm:px-6">
                                        <button type="button" @click="step++" class="rounded-md bg-primary-600 px-3.5 py-2.5 text-base font-semibold text-white shadow-xs hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600">Solicite uma Proposta</button>
                                    </div>
                                </div>
                            </div>
                            <!-- FIM Etapa 1 -->
                                ...
                                <div class="shadow-sm overflow-hidden sm:rounded-md">
                                    <div class="px-4 py-5 bg-white sm:p-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                            ...
                                            <input type="text" name="name" id="name" value="{{ old('name') }}" autocomplete="given-name" class="mt-1 focus:ring-lio-300 focus:border-lio-300 block w-full shadow-xs sm:text-sm border-gray-300 rounded-md">
                                            @error('name') <span>{{ $message }}</span> @enderror
                                        </div>

                                        <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                            <label for="representante" class="block text-base font-medium text-gray-700">Representante da Empresa</label>
                                            <input type="text" name="representante" id="representante" value="{{ old('representante') }}" autocomplete="given-representante" class="mt-1 focus:ring-lio-300 focus:border-lio-300 block w-full shadow-xs sm:text-sm border-gray-300 rounded-md">
                                        ...
                                        <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                            ...
                                            <input id="email" type="email" required name="email" value="{{ old('email') }}" autocomplete="email" class="mt-1 focus:ring-primary-600 focus:border-primary-600 block w-full shadow-xs sm:text-base border-gray-300 rounded-md">
                                        ...
                                        <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                            ...
                                            <input id="phone_celular" type="text" required name="phone_celular" value="{{ old('phone_celular') }}" autocomplete="phone_celular" x-mask="(99) 99999-9999" placeholder="Celular" class="mt-1 focus:ring-primary-600 focus:border-primary-600 block w-full shadow-xs sm:text-base border-gray-300 rounded-md">
                                        ...
                                        <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                            ...
                                            <input id="phone_fixo" type="text" name="phone_fixo" value="{{ old('phone_fixo') }}" autocomplete="phone_fixo" x-mask="(99) 9999-9999" placeholder="Fixo" class="mt-1 focus:ring-primary-600 focus:border-primary-600 block w-full shadow-xs sm:text-base border-gray-300 rounded-md">
                                            @error('phone_fixo') <span>{{ $message }}</span> @enderror
                                        </div>

                                        <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                            <label for="cnpj" class="block text-gray-700 text-sm font-bold mb-2">CNPJ</label>
                                            <input type="text" id="cnpj" name="cnpj" value="{{ old('cnpj') }}" x-mask="99.999.999/9999-99" placeholder="Digite o CNPJ" class="mt-1 focus:ring-primary-600 focus:border-primary-600 block w-full shadow-xs sm:text-base border-gray-300 rounded-md">
                                        ...
                                        <div class="inline col-span-6 sm:col-span-1">
                                            ...
                                            <input type="text" name="cep" id="cep" value="{{ old('cep') }}" autocomplete="cep" 
                                        ...
                                        <div class="px-5 mb-4 lg:mt-6 col-span-6 sm:col-span-1 ">
                                            <div class="mt-2 flex items-center gap-x-3">
                                                <button type="button" @click="fetchCep()" class="bg-primary-600 text-white px-4 py-2 rounded-sm">
                                        ...
                                        <div class="mb-4 col-span-6 sm:col-span-3">
                                            ...
                                            <input type="text" name="endereco" id="endereco" value="{{ old('endereco') }}" autocomplete="endereco" class="mt-1 focus:ring-primary-600 focus:border-primary-600 block w-full shadow-xs sm:text-sm border-gray-300 rounded-md">
                                        </div>

                                        <div class="mb-4 col-span-6 sm:col-span-1">
                                            <label for="numero" class="block text-gray-700 text-sm font-bold mb-2">Número</label>
                                            <input type="text" name="numero" id="numero" value="{{ old('numero') }}" autocomplete="numero" class="mt-1 focus:ring-primary-600 focus:border-primary-600 block w-full shadow-xs sm:text-sm border-gray-300 rounded-md">
                                        </div>

                                        <div class="mb-4 col-span-6 sm:col-span-1">
                                            <label for="complemento" class="block text-gray-700 text-sm font-bold mb-2">Complemento</label>
                                            <input type="text" name="complemento" id="complemento" value="{{ old('complemento') }}" autocomplete="complemento" class="mt-1 focus:ring-primary-600 focus:border-primary-600 block w-full shadow-xs sm:text-sm border-gray-300 rounded-md">
                                        </div>

                                        <div class="mb-4 col-span-6 sm:col-span-2">
                                            <label for="bairro" class="block text-gray-700 text-sm font-bold mb-2">Bairro</label>
                                            <input type="text" name="bairro" id="bairro" value="{{ old('bairro') }}" autocomplete="bairro" class="mt-1 focus:ring-primary-600 focus:border-primary-600 block w-full shadow-xs sm:text-sm border-gray-300 rounded-md">
                                        </div>

                                        <div class="mb-4 col-span-6 sm:col-span-2">
                                            <label for="cidade" class="block text-gray-700 text-sm font-bold mb-2">Cidade</label>
                                            <input type="text" name="cidade" id="cidade" value="{{ old('cidade') }}" autocomplete="cidade" class="mt-1 focus:ring-primary-600 focus:border-primary-600 block w-full shadow-xs sm:text-sm border-gray-300 rounded-md">
                                        </div>

                                        <div class="mb-4 col-span-6 sm:col-span-1">
                                            <label for="estado" class="block text-gray-700 text-sm font-bold mb-2">Estado</label>
                                            <input type="text" name="estado" id="estado" value="{{ old('estado') }}" autocomplete="estado" class="mt-1 focus:ring-primary-600 focus:border-primary-600 block w-full shadow-xs sm:text-sm border-gray-300 rounded-md">
                                        </div>

                                        <div class="col-span-6">
                                            <label for="funcionarios" class="block text-base font-medium text-gray-700">Número de Funcionário</label>
                                            <input type="text" name="funcionarios" id="funcionarios" value="{{ old('funcionarios') }}" autocomplete="funcionarios" class="mt-1 focus:ring-lio-300 focus:border-lio-300 block w-full shadow-xs sm:text-sm border-gray-300 rounded-md">
