    ...
    <section class="mt-12 container mx-auto lg:mt-24 lg:px-16">
        <div class="px-4 lg:px-0">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <div x-data="{ step: 1, isCnpj: false }">
                    <!-- Success message -->
                    ...
                    @endif
                    <div>
                        <form action="{{ route('forms.cartao.submit') }}" method="post">
                            @CSRF
                            <!-- Step 1 -->
                            <div x-show="step === 1">
                                ...
                                <div class="shadow-sm overflow-hidden sm:rounded-md">
                                    <div class="px-4 py-5 bg-white sm:p-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-3 pb-5">
                                            <label for="renda" class="block text-gray-700 text-sm font-bold mb-2">Informe sua Renda</label>
                                            <select id="renda" name="renda" autocomplete="renda-name" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-xs focus:outline-hidden focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                                                <option>Informe sua Renda</option>
                                        ...
                                        <div class="col-span-6 sm:col-span-3 pb-5">
                                            <label for="bandeira" class="block text-gray-700 text-sm font-bold mb-2">Escolha a Bandeira</label>
                                            <select id="bandeira" name="bandeira" autocomplete="bandeira-name" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-xs focus:outline-hidden focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                                                <option>Escolha a Bandeira</option>
                                                <option>Visa</option>
