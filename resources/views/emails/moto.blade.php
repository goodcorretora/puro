<x-email-layout 
    icon="🏍️" 
    heading="Nova Solicitação de Seguro Moto"
    subheading="Solicitação de Cotação de Seguro Moto recebida com sucesso">
    ...
    <x-email-section icon="🏍️" title="Informações da Moto">
        @if(!empty($placa))
