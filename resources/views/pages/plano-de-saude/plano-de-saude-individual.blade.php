<x-layouts.app>
    <x-slot name="title">Plano de Saúde Individual</x-slot>
    ...
    <div class="container mx-auto flex justify-center mt-14">
        <div class="w-full mx-4 text-center">
            ...
            <div class="mt-6 grid gap-2 lg:grid-cols-2">
                ...
                <div href="{{ ('plano-de-saude-individual') }}" class="py-2 px-2 bg-white primary-xl shadow-lg space-y-2 flex items-center space-x-6">
    ...
    <div class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
                <a href="{{url('solicitar-plano-de-saude')}}" class="text-2xl bg-primary-600 text-gray-200 primary hover:bg-primary-500 px-4 py-3 focus:outline-hidden" type="button">
    ...
    <div class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="shadow-xl p-3 mb-5 primary lg:text-center text-gray-800 text-lg leading-8 font-medium">
                <p>
