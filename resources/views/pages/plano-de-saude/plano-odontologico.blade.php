<x-layouts.app>
    <x-slot name="title">Plano Odontológico</x-slot>

    <div class="bg-primary-600">
        <img  src="{{ asset('images/planodesaude/odonto.png') }}" class="img-fluid h w-full h-96" alt="" />

        <div class="-mt-80 w-full mx-4 text-center">

            <h1 class="text-3xl font-bold text-primary-600 leading-tight mb-3 lg:text-6xl">
                Plano Odontológico 
            </h1>
            <p class="mt-3 text-lg font-bold text-gray-50 mb-6 ">
                Benefícios para exibir um sorriso saudável com custo acessível.
            </p>
            <p class="mt-3 text-lg font-bold text-gray-50 mb-6 ">
                São para para você, coletivo e empresarial.
            </p>

            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">       
                <div class="lg:text-center"> 
                    <a href="{{url('solicitar-plano-de-saude')}}" class="text-base font-medium items-center justify-center border border-transparent bg-primary-600 text-gray-50 rounded-sm hover:bg-primary-700 px-4 py-3 focus:outline-hidden md:py-4 md:text-lg md:px-10" type="button">
    ...
    <div class="container mx-auto flex justify-center mt-32">
        <div class="w-full mx-4 text-center">
            ...
            <div class="mt-6 grid gap-2 lg:grid-cols-2">
                ...
                <div href="{{ ('plano-odontologico') }}" class="py-2 px-2 bg-white rounded-xl shadow-lg space-y-2 flex items-center space-x-6">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap -m-4 justify-center text-center">
                <div class="xl:w-1/4 md:w-1/2 p-4">
                    <div class="shadow-lg rounded-lg h-96 mb-6 p-5">
                        <i class="fa fa-tooth fa-3x mb-6 text-primary-600"></i>
                        <h2 class="text-2xl text-gray-900 font-medium title-font mb-12">
                            Exclusivamente Odontológico
                        </h2>
                        <h2 class="text-lg text-black font-semibold p-4 mb-10">
                            Só para consultas e exames odontológicos.
                        </h2>
                        <p class="leading-relaxed text-sm mb-4 pb-8">
                ...
                <div class="xl:w-1/4 md:w-1/2 p-4">
                    <div class="shadow-lg rounded-lg h-96 p-5">
                        <i class="fa fa-tooth fa-3x mb-6 text-primary-600"></i>
                        <i class="fa fa-clinic-medical fa-3x mb-6 text-primary-600"></i>
                        <h2 class="text-2xl text-gray-900 font-medium title-font mb-8">
                            Ambulatorial + Odontológico
                        </h2>
                        <h2 class="text-lg text-black font-semibold p-4 mb-8">
                            Só para consultas, exames, terapias e odontológico.
                        </h2>
                        <p class="leading-relaxed text-sm mb-6 pb-6">
                            <a href="solicitar-plano-de-saude" class="px-4 py-1 text-lg text-primary-600 font-semibold rounded-full border border-primary-200 hover:text-white hover:bg-primary-600 hover:border-transparent focus:outline-hidden focus:ring-2 focus:ring-primary-600 focus:ring-offset-2">
                                Solicitar
                            </a>
                        </p>
                ...
                <div class="xl:w-1/4 md:w-1/2 p-4">
                    <div class="shadow-lg rounded-lg h-96 p-5">
                        ...
                        <i class="fa fa-tooth fa-3x mb-6 text-primary-600"></i>
                        <h2 class="text-2xl text-gray-900 font-medium title-font mb-1">
                            Ambulatorial + Hospitalar sem obstetrícia + Odontológico
                        </h2>
                        <h2 class="text-lg text-black font-semibold p-4 mb-1">
    ...
    <div class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
                <p class="text-2xl font-semibold mb-4">
                    Sua escolha de um bom plano odontológico começa aqui.
                </p>
                <a href="{{url('solicitar-plano-de-saude')}}" class="text-2xl bg-primary-600 text-gray-200 rounded-sm hover:bg-primary-500 px-4 py-3 focus:outline-hidden" type="button">
                    Solicitar uma proposta
                </a>
