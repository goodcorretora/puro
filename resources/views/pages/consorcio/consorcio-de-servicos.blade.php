<x-layouts.app>
    <x-slot name="title">Consórcio de Serviços</x-slot>

  <div class="py-2 bg-primary-600">
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
      <div class="w-full md:w-1/2 md:px-3">
        <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
          <span class="block text-gray-50 xl:inline">Consórcio de Serviços</span>
        </h1>
        ...
        <p class="mt-3 text-lg leading-8 font-medium  text-gray-50 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
          Com uma carta de crédito do Consórcio de Serviços você pode realizar diversos projetos.
        </p>
      ...
      <div class="mt-8 sm:mr-4 flex items-center lg:mt-0 lg:shrink-0">
        <img src="{{ asset('images/consorcio/consorcioservicos.png') }}" class=" w-96 rounded-lg" alt="" />
      </div>
    </div>
  </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="lg:text-center">
        <h1 class="text-3xl font-bold text-gray-900 leading-tight mb-3 lg:text-6xl">
          Veja os diversos serviços que você pode adquirir com o Consórcio de Serviços
        </h1>
      </div>

      <div class="flex flex-col items-center px-4 lg:flex-row lg:px-0 mb-12">
        <div class="w-full lg:w-1/2 lg:mb-0 lg:mr-16">
          <ul class="space-y-4 mb-8 text-gray-800 text-lg leading-8 font-medium">
            <li class="flex items-center">
              <i class="fa-solid fa-circle-check fa-xl text-primary-600 mr-2"></i>
              <p class="ml-4">Viagens (férias ou intercâmbios), cursos de ensino superior.
              </p>
            </li>
            <li class="flex items-center">
              <i class="fa-solid fa-circle-check fa-xl text-primary-600 mr-2"></i>
              <p class="ml-4">
                Não tem juros, pois você se autofinancia;</p>
            </li>
            <li class="flex items-center">
              <i class="fa-solid fa-circle-check fa-xl text-primary-600 mr-2"></i>
              <p class="ml-4">
                Parcelas acessíveis ao seu planejamento financeiro;</p>
            </li>
            <li class="flex items-center">
              <i class="fa-solid fa-circle-check fa-xl text-primary-600 mr-2"></i>
              <p class="ml-4">
            ...
            <li class="flex items-center">
              <i class="fa-solid fa-circle-check fa-xl text-primary-600 mr-2"></i>
              <p class="ml-4">
                Proporciona mais disciplina financeira;
            </li>
          </ul>
        ...
        <div class="lg:w-1/2">
          <img src="{{ asset('images/consorcio/viagem.png') }}" class="rounded-lg" alt="" />
        </div>
      </div>
      ...
      <div class="flex flex-col items-center px-4 lg:flex-row lg:px-0 mb-12">
        <div class="lg:w-1/2">
          <img src="{{ asset('images/consorcio/procedimentoestetico.png') }}" class="rounded-lg" alt="" />
        </div>
        <div class="w-full lg:w-1/2 lg:mb-0 lg:mr-16">
          <ul class="space-y-4 mb-8 text-gray-800 text-lg leading-8 font-medium">
            <li class="flex items-center">
            ...
            <li class="flex items-center">
              <i class="fa-solid fa-circle-check fa-xl text-primary-600 mr-2"></i>
              <p class="ml-4">
                Com uma carta de crédito de serviços serve para efetuar o pagamento de qualquer tipo de serviço contratado.
              </p>
            </li>
            <li class="flex items-center">
              <i class="fa-solid fa-circle-check fa-xl text-primary-600 mr-2"></i>
              <p class="ml-4">
                E opções não faltam, pois com o consórcio de serviços da MAPFRE Associada à BR Consórcios é possível obter crédito para viajar, fazer cursos de especialização e intercâmbios, cirurgias estéticas ou restauradoras, pagar as despesas da floricultura, músicos e do buffet do casamento, pintar a casa ou o condomínio residencial e muito mais.
              </p>
            </li>
            <li class="flex items-center">
              <i class="fa-solid fa-circle-check fa-xl text-primary-600 mr-2"></i>
          ...
          <a href="{{url('solicitar-consorcio')}}" class="mt-5 text-2xl bg-primary-600 text-gray-200 rounded-sm hover:bg-primary-500 px-4 py-3 focus:outline-hidden" type="button">
            Solicitar uma proposta
          </a>
        </div>
      </div>
      ...
      <div class="flex flex-col items-center px-4 lg:flex-row lg:px-0 mb-12">
        <div class="w-full lg:w-1/2 lg:mb-0 lg:mr-16">
          <ul class="space-y-4 mb-8 text-gray-800 text-lg leading-8 font-medium">
            <li class="flex items-center">
              <i class="fa-solid fa-circle-check fa-xl text-primary-600 mr-2"></i>
              <p class="ml-4">Contratar profissionais para festas e eventos (fotografia e filmagem, buffet, decoração, som, luzes, etc.).
              </p>
            </li>
            <li class="flex items-center">
              <i class="fa-solid fa-circle-check fa-xl text-primary-600 mr-2"></i>
        ...
        <div class="lg:w-1/2">
          <img src="{{ asset('images/consorcio/intercambio.png') }}" class="rounded-lg" alt="" />
        </div>
      </div>
      ...
      <div class="flex flex-col items-center px-4 lg:flex-row lg:px-0 mb-12">
        <div class="lg:w-1/2">
          <img src="{{ asset('images/consorcio/festabalada.png') }}" class="rounded-lg" alt="" />
        </div>
        <div class="w-full lg:w-1/2 lg:mb-0 lg:mr-16">
          <ul class="space-y-4 mb-8 text-gray-800 text-lg leading-8 font-medium">
            <li class="flex items-center">
              <i class="fa-solid fa-circle-check fa-xl text-primary-600 mr-2"></i>
              <p class="ml-4">
                Contratar mão-de-obra especializada e muitos outros.
              </p>
            </li>
            <li class="flex items-center">
              <i class="fa-solid fa-circle-check fa-xl text-primary-600 mr-2"></i>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="lg:text-center">
        <div class="p-3 mb-5 rounded-sm lg:text-center text-gray-800 text-lg leading-8 font-medium">
          <h4 class="mb-6">
            Escolha uma das opções que o Consórcio de Serviços lhe oferece para realizar procedimentos estéticos, cirúrgicos, contratar profissionais para festas e eventos (fotografia e filmagem, buffet, decoração, som, luzes, etc.), fazer viagens (férias ou intercâmbios), cursos de ensino superior, contratar mão-de-obra especializada e muitos outros.
          </h4>
